<!-- pre-align:aligned sig=9fe7e0dacba1 -->

<a id="database-rds-for-ms-sql-backup-and-restoration"></a>
## Database > RDS for MS-SQL > Backup and Restoration { #database-rds-for-ms-sql-backup-and-restoration }
...
<a id="restoration-with-backup"></a>
### Restoration with Backup { #restoration-with-backup }
...
<a id="point-in-time-restoration-during-backup-retention-period"></a>
### Point-in-Time Restoration during Backup Retention Period { #point-in-time-restoration-during-backup-retention-period }
...
<a id="export-and-import-backup-using-object-storage"></a>
## Export and Import Backup using Object Storage { #export-and-import-backup-using-object-storage }
