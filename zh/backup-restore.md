...
If the backup file to restore exceeds 5GB, it must be uploaded in multiple parts. For more information, please refer to [Multi-part upload](https://docs.nhncloud.com/ko/Storage/Object%20Storage/ko/api-guide/#_52).
