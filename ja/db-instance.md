...
## Database > RDS for MS-SQL > DBインスタンス { #database-rds-for-ms-sql-db-instance }
...
### Microsoft SQL Serverバージョン { #version-of-microsoft-sql-server }
...
### DBインスタンスモニタリング状態 { #db-instance-monitoring-status }
