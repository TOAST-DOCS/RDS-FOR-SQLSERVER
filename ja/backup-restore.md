...
## Database > RDS for MS-SQL > バックアップおよび復元 { #database-rds-for-ms-sql-backup-and-restoration }
...
### バックアップを利用した復元 { #restoration-with-backup }
...
### バックアップ保管期間中の任意の時点に復元 { #point-in-time-restoration-during-backup-retention-period }
...
## オブジェクトストレージを利用したバックアップのエクスポートおよびインポート { #export-and-import-backup-using-object-storage }
