...
![DBインスタンス作成001](http://static.toastoven.net/prod_rds_mssql/db_instance_create_001.png)
...
![DBインスタンスリスト > 条件001](http://static.toastoven.net/prod_rds_mssql/db_instance_list_cond_001.png)
...
![DBインスタンスリスト002](http://static.toastoven.net/prod_rds_mssql/db_instance_list_002.png)
...
![DBインスタンス修正001](http://static.toastoven.net/prod_rds_mssql/db_instance_modify_001.png)
...
![DBインスタンス詳細 > 基本情報001](http://static.toastoven.net/prod_rds_mssql/db_instance_detail_inst_001.png)

* ❶ [変更]ボタンを押すと、DBインスタンスの名前を変更できます。
* ❷ [コピー]ボタンを押すと、DBインスタンスのIDをクリップボードにコピーします。
* ❸ DBインスタンスに接続できるIP情報が表示されます。Floating IP使用時は、133から始まるIPが追加で表示され、DBセキュリティグループ設定に応じて外部から接続できます。
