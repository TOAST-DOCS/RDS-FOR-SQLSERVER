...
## Database > RDS for MS-SQL > コンソール使用ガイド { #database-rds-for-ms-sql-console-user-guide }
...
### DBインスタンス作成 { #create-a-db-instance }
...
### DBインスタンスリスト { #list-of-db-instances }
...
### DBインスタンス再起動 { #restart-a-db-instance }
...
### DBインスタンス強制再起動 { #force-restart-a-db-instance }
...
### DBインスタンス修正 { #modify-a-db-instance }
...
### オブジェクトストレージに差分バックアップ { #differential-backup-to-object-storage }
...
### オブジェクトストレージにあるバックアップで復元 { #restore-from-backup-in-object-storage }
...
### オブジェクトストレージにバックアップをエクスポート { #export-a-backup-to-object-storage }
...
### バックアップを利用した復元 { #restore-using-backup }
...
### バックアップ保管期間中の任意の時点に復元 { #point-in-time-restoration }
...
### 最近のイベントリスト { #list-of-recent-events }
...
### パラメータグループ作成 { #create-a-parameter-group }
...
### パラメータグループ修正 { #modify-a-parameter-group }
...
### パラメータグループ比較 { #compare-parameter-groups }
...
### DBセキュリティグループ作成 { #create-a-db-security-group }
...
### DBセキュリティグループ修正 { #modify-a-db-security-group }
...
### セキュリティポリシー修正 { #modify-security-policies }
...
### ユーザーレイアウトの活用 { #how-to-use-user-layouts }
...
### 通知グループ作成 { #create-a-notification-group }
...
### 通知グループ修正 { #modify-a-notification-group }
...
### 通知グループ監視設定 { #notification-group-monitoring-settings }
...
### ユーザーグループ作成 { #create-a-user-group }
...
### ユーザーグループ修正 { #modify-a-user-group }
