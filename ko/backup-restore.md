...
## Database > RDS for MS-SQL > 백업 및 복원 { #database-rds-for-ms-sql-backup-and-restoration }
...
### 백업 보관 기간 중 어느 한 시점으로 복원 { #point-in-time-restoration-during-backup-retention-period }
...
## 오브젝트 스토리지를 이용한 백업 내보내기 및 가져오기 { #export-and-import-backup-using-object-storage }
...
복원할 백업 파일이 5GB를 초과하면 멀티 파트 형태로 올려야 합니다. 자세한 사용법은 [멀티 파트 업로드](https://docs.nhncloud.com/ko/Storage/Object%20Storage/ko/api-guide/#_45)를 참고해주세요.
