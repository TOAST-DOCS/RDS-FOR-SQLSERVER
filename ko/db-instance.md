...
## Database > RDS for MS-SQL > DB 인스턴스 { #database-rds-for-ms-sql-db-instance }
...
### DB 인스턴스 모니터링 상태 { #db-instance-monitoring-status }
...
### 고가용성 자동 복구 { #high-availability-auto-recovery }
...
### 주의 및 제약 사항 { #cautions-and-constraints }
